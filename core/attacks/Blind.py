    ...
    def train(self, schedule=None):
        ...
        for i in range(self.current_schedule['epochs']):
            ...
            if (i + 1) % self.current_schedule['test_epoch_interval'] == 0 or (i + 1) == self.current_schedule['epochs']:
                ...
                # get acc
                acc = 1.0 * top1_correct / total_num
                print(f'[+] Epoch {i+1} / {self.current_schedule["epochs"]}, acc: {acc}')
                ...
                # get asr
                asr = 1.0 * top1_correct / total_num
                print(f'[+] Epoch {i+1} / {self.current_schedule["epochs"]}, asr: {asr}')
